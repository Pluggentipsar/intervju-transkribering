  ...
  const modalContent = (
    ...
    >
      <div className="min-h-full flex items-center justify-center p-4 pt-20 pb-4">
        <div
          className="bg-dark-800 rounded-3xl shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-hidden animate-fade-in flex flex-col"
              ...
              <div className="mt-4 p-4 bg-blue-500/10 border border-blue-500/20 rounded-xl">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <ol className="text-sm text-blue-400 list-decimal list-inside space-y-1 mb-3">
          ...
          >
            <div className="space-y-4">
              <div className="flex items-start gap-3 p-3 bg-green-500/10 border border-green-500/20 rounded-xl">
                ...
                <div>
                  <p className="font-medium text-green-300">100% lokal bearbetning</p>
              ...
              <div className="flex items-start gap-3 p-3 bg-amber-500/10 border border-amber-500/20 rounded-xl">
                ...
                <div>
                  <p className="font-medium text-amber-300">Viktig information om avidentifiering</p>
                  <p className="text-sm text-amber-400 mb-2">
                    Avidentifieringen använder AI-modeller som kan missa känslig information.
                    AI är inte perfekt och kan:
                  </p>
                  <ul className="text-sm text-amber-400 list-disc list-inside space-y-1">
              ...
              <div className="flex items-start gap-3 p-3 bg-red-500/10 border border-red-500/20 rounded-xl">
                ...
                <div>
                  <p className="font-medium text-red-300">Granska alltid resultatet</p>
          ...
          >
            <div className="space-y-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 p-3 bg-dark-900/50 rounded-xl hover:bg-white/10 transition-colors group"
              >
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-400">Guider och FAQ</p>
                </div>
                <ExternalLink className="w-4 h-4 text-gray-400" />
              </a>
            </div>
...
function ModelCard({ name, description, link }: ModelCardProps) {
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="block p-3 bg-dark-800/50 rounded-xl border border-white/10 hover:border-primary-500/20 hover:shadow-md transition-all group"
    >
...
function RequirementCard({ icon: Icon, label, value }: RequirementCardProps) {
  return (
    <div className="flex items-center gap-3 p-3 bg-dark-800/50 rounded-xl border border-white/10">
